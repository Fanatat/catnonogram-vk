...
window.I18N = (function () {
  var STRINGS = {
    ru: {
      ...
      // ТЗ №49а: было фикс. «подсказки» (мн.ч.) — при n=1 читалось «+1
      ...
      ladderTitle:    'Серия: {n} дн.',
      ladderDay:      'День {d} из 7',
      ladderToday:    'Сегодня: {r}',
      ladderTomorrow: 'Завтра: {r}',
      ladderClaim:    'Забрать',
      seriesLine:     'Серия: {n} дн. · день {d} из 7',
      rewardHintsOne:  'подсказка',
      rewardHintsFew:  'подсказки',
      ...
      chapter01Name: 'Азбука',
      chapter02Name: 'Тёплый дом',
      chapter03Name: 'В саду',
      chapter04Name: 'Вкусно!',
      chapter05Name: 'Гардероб',
      chapter06Name: 'Полезные вещи',
      chapter07Name: 'Праздник и музыка',
      chapter08Name: 'Спорт',
      chapter09Name: 'Погода и стихии',
      chapter10Name: 'Зверята',
      chapter11Name: 'В путь',
      chapter12Name: 'Королевство',
      chapter13Name: 'Полёт и красота',
      ...
      // ТЗ №51: кнопка «Проверить», тосты, шеринг в историю ВК.
      check:        'Проверить',
      checkFree:    'бесплатно',
      checkForHint: 'за подсказку',
      checkForAd:   'за рекламу',
      checkNoErrors:'Ошибок нет',
      ...
      cellWordMany: 'клеток',
      share:        'Поделиться',
      shareDone:    'Опубликовано',
      storyDaily:   'Пазл дня, {date}',
      storyChapter: 'глава «{name}»',
    },
    en: {
      loading:   'Loading…',
      ...
      ladderToday:    'Today: {r}',
      ladderTomorrow: 'Tomorrow: {r}',
      ladderClaim:    'Claim',
      seriesLine:     'Streak: {n} d. · day {d} of 7',
      rewardHintsOne:  'hint',
      rewardHintsFew:  'hints',
      ...
      chapter01Name: 'Alphabet',
      chapter02Name: 'Cozy Home',
      chapter03Name: 'In the Garden',
      chapter04Name: 'Yummy!',
      chapter05Name: 'Wardrobe',
      chapter06Name: 'Handy Things',
      chapter07Name: 'Party & Music',
      chapter08Name: 'Sports',
      chapter09Name: 'Weather & Elements',
      chapter10Name: 'Baby Animals',
      chapter11Name: 'On the Road',
      chapter12Name: 'Kingdom',
      chapter13Name: 'Flight & Beauty',
      ...
      // ТЗ №51: check button, toasts, VK story sharing.
      check:        'Check',
      checkFree:    'free',
      checkForHint: 'for a hint',
      checkForAd:   'via ad',
      checkNoErrors:'No errors',
      checkFixed:   'Fixed: {n}',
      ...
      share:        'Share',
      shareDone:    'Published',
      storyDaily:   'Daily puzzle, {date}',
      storyChapter: 'chapter “{name}”',
    },
  };
