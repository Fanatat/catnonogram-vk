...
window.I18N = (function () {
  var STRINGS = {
    ru: {
      ...
      catLocked:          'Скоро откроется',
      retentionDripLine:  'Открыто и ждёт: {n}',
      retentionNextAt:    'Следующий пазл в {time}',
      retentionFull:      'Накопилось максимум — играйте, чтобы открыть ещё',
    ...
    en: {
      ...
      catLocked:          'Unlocks soon',
      retentionDripLine:  'Unlocked and waiting: {n}',
      retentionNextAt:    'Next puzzle at {time}',
      retentionFull:      'Backlog is full — play to unlock more',
